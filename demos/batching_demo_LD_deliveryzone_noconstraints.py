...
from opt.defaults.cost import GraphTaskClusterCost_ExtraNode_v2
from opt.model.optimizer import Optimizer
from opt.algorithms.kmedoids import initialize_task_assignments
from opt.defaults.modifier import ClusterSplitMerge, SwappingMergingMix
...
print("initial cost", distanceCost.eval(cluster_assigns))
