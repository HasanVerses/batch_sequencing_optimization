...
TOTAL_SECONDS = 10445164

MILES_CONVERTER = 0.621371

PATH_SCHEMA = "ofsize_sequenced/size{size}/totals/size{size}_totals.csv"
...
for size in size_range:
    ...
    dollars_saved_seq = 25.87*hours_saved_seq
    dollars_saved_seq_bat = 25.87*hours_saved_seq_bat
    dollars_saved_bat = 25.87*hours_saved_bat
...
savings_df.to_csv("LD_batching_savings.csv")
...
plt.savefig("batching_results_per_size.png")
plt.clf()


# Variances

PATH_SCHEMA = "ofsize_sequenced/size{size}/*.csv" 
means = []
variances = []
...
plt.savefig("batching_results_batch_sizes.png")
