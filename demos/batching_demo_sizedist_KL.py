...
from app.defaults.cost import GraphClusterCost, SizeDistCost 
...
G = random_graph(128) # create randomly locally-connected rectangular spatial graph
...
opt = Optimizer(costs = [distanceCost, klCost], 
