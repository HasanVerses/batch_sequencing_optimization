...
def test_reslot_sequencing_with_genetic_minimal_cart_capacity():
...
def test_reslot_sequencing_with_genetic_crossover_minimal_cart_capacity():

    seq, _, _ = genetic_crossover(
        G, 
        locations=sources + encoded_destinations, 
        initial_state=initial_state, 
        decoder=decode_destination_nodes,
...
def test_reslot_sequencing_with_genetic_larger_cart_capacity():
...
def test_reslot_sequencing_with_genetic_crossover_larger_cart_capacity():
...
def test_reslot_sequencing_with_genetic_distance():
...
def test_reslotting_genetic_with_api_minimal_capacity():
    ...
    _, sequence, _ = optimize_swaps(G2, [test_sources, test_destinations], cart_capacity=1, algorithm="genetic", constraint_weight=100, constraint_weight_base=None, output_csv_format=None)

    assert all(reslotting_constraints(sequence.raw, **constraint_fn_kwargs))


def test_reslotting_genetic_with_api_larger_capacity():
    ...
    _, sequence, _ = optimize_swaps(G2, [test_sources, test_destinations], constraint_weight=100, algorithm="genetic", constraint_weight_base=None, output_csv_format=None)
